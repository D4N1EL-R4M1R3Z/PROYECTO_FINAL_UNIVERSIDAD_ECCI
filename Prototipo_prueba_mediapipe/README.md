...
- Este cuenta con 2 etapas:
  1. Detección y escritura de landmarks sobre sujeto de prueba, adicional de pasos para exportar esta data de información a csv para su posterior análisis con el segundo código **[Archivo Principal]('Prototipo_prueba_mediapipe/Analisis_post_process.py')**.
